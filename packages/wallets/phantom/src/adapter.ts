...
import {  PublicKey as SPublicKey } from '@solana/web3.js';
...
export class PhantomWalletAdapter extends BaseMessageSignerWalletAdapter {
    ...
    private _publicKey: Ed25519PublicKey | null;
    ...
    get publicKey(): Ed25519PublicKey | null {
        return this._publicKey;
    }
    get solanaPublicKey(): SPublicKey | null {
        if(this.publicKey)
        return new SPublicKey(this.publicKey.bytes) 
        return null;
    }
